...
| Drift | How to see it |
|---|---|
| **A story no longer covers its epic** | read the epic body, then each `decomposes` child; the epic promises an outcome no story claims, or a story claims something the epic no longer wants |
