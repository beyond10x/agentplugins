...
The first line registers the repository at the immutable `0.5.0` release; each install names its
...
The block above is already pinned to the bare `0.5.0` release tag. Upgrade by changing that tag
